...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
        <form id="customer">
          <input type="hidden" id="customer_id"  value=" <?=$data['customer'][0]['id'] ?? ''?>">
            <div class="card-body">
                    <div class="form-group">
                        <label for="customer_name"></label>
                        <input type="text" class="form-control" id="customer_name" value=" <?=$data['customer'][0]['name'] ?? '';?>">
                    </div>           
            </div>
            <div class="card-body">
                    <div class="form-group">
                        <label for="customer_surname">Müşteri Soyadı</label>
                        <input type="text" class="form-control" id="customer_surname" value=" <?=$data['customer'][0]['surname'] ?? '';?>">
                    </div>           
            </div>
            <div class="card-body">
                    <div class="form-group">
                        <label for="customer_company">Firma Adı</label>
                        <input type="text" class="form-control" id="customer_company" value=" <?=$data['customer'][0]['company'] ?? '';?>">
                    </div>           
            </div>
            <div class="card-body">
                    <div class="form-group">
                        <label for="customer_phone">Sabit Telefon</label>
                        <input type="text" class="form-control" id="customer_phone" value=" <?=$data['customer'][0]['phone'] ?? '';?>">
                    </div>           
            </div>
            <div class="card-body">
                    <div class="form-group">
                        <label for="customer_gsm">GSM</label>
                        <input type="text" class="form-control" id="customer_gsm" value=" <?=$data['customer'][0]['gsm'] ?? '';?>">
                    </div>           
            </div>
            <div class="card-body">
                    <div class="form-group">
                        <label for="customer_email">E-Posta</label>
                        <input type="text" class="form-control" id="customer_email" value=" <?=$data['customer'][0]['email'] ?? '';?>">
                    </div>           
            </div>
            <div class="card-body">
                    <div class="form-group">
                        <label for="customer_address" id="customer_address">Adress</label>
                        <textarea class="form-control" id="customer_address"><?=$data['customer'][0]['address'] ?? '';?></textarea>
                    </div>           
            </div>
